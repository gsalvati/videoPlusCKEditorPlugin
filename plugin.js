...
CKEDITOR.plugins.add( 'video',
{
	...
	init : function( editor )
	{
		...
		CKEDITOR.dtd.$empty['cke:track']=1;
		CKEDITOR.dtd.$empty['track']=1;
				...
				$ : function( realElement )
				{
						if ( realElement.name == 'video' )
						{
							...
							for( var i=0; i < realElement.children.length; i++)
							{
								...
								if ( realElement.children[ i ].name == 'track' )
									realElement.children[ i ].name = 'cke:track'
							}
...
var en = {
		...
		subtitleVideo: 'Subtitle source',
		subtitleLabelVideo: 'Subtitle label',
...
var es = {
		...
		poster: 'Imagen de presentaciõn',
		sourceVideo: 'Archivo de video',		
		subtitleVideo: 'Archivo de legenda',
		subtitleLabelVideo: 'Nombre de legenda',
		subtitleLang: 'Lingua',
		sourceType : 'Tipo',
		linkTemplate :  '<a href="%src%">%type%</a> ',
...
var pt_br =  {
	toolbar	: 'Vídeo',
	dialogTitle : 'Propiedades do vídeo',
	fakeObject : 'Vídeo',
	properties : 'Editar o vídeo',
	widthRequired : 'A largura não pode ficar em branco',
	heightRequired : 'A altura não pode ficar em branco',
	poster: 'Imagem de apresentação',
	sourceVideo: 'Arquivo de vídeo',
	subtitleVideo: 'Arquivo de legenda',
	subtitleLabelVideo: 'Nome da legenda',
	subtitleLang: 'Língua',
	sourceType : 'Tipo',
	linkTemplate :  '<a href="%src%">%type%</a> ',
	fallbackTemplate : 'Seu navegador não suporta VIDEO.<br>Por favor, baixe o arquivo: %links%'
};
...
CKEDITOR.plugins.setLang( 'video', 'pt-br', pt_br );
